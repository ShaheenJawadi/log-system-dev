...
const SingleLogGrid = ({single,action}:{single:LogDay , action:(target:'openMap'|'singleLog'|"delete")=>void}) => {
  return (
    <Grid size={4}>
      <Card>
        <CardContent>
          <Stack spacing={5}>
            ...
            <Stack spacing={3}>
              <Stack flex={1}>
                ...
                <Typography variant="body1"> {single.log_sheet?.fromLocation}</Typography>
              </Stack>
              <Stack flex={1} direction={"row"}>
                <Typography variant="h6" color="secondary">
                  To:
                </Typography>
                <Typography variant="body1"> {single.log_sheet?.toLocation}</Typography>
              </Stack>
            </Stack>
